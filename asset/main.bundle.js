...
var AppComponent = (function () {
    function AppComponent(router, route, campaignService) {
        this.router = router;
        this.route = route;
    ...
    AppComponent.prototype._ngOnInit = function () {
        ...
        this.campaignService.getAccount(advertiserId).then(function (acct) {
            if (acct) {
                console.log('got acct: ' + JSON.stringify(acct));
                _this.campaignService.account = acct;
            }
            _this.loginIfRequired();
        }, function (err) {
            _this.loginIfRequired();
            console.log(err.message ? err.message : JSON.stringify(err));
        });
    };
    AppComponent.prototype.loginIfRequired = function () {
        this.app_loaded = true;
...
var CampaignComponent = (function () {
    ...
    CampaignComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_2__services_campaign_service__["a" /* CampaignService */]])
    ], CampaignComponent);
...
var LoginComponent = (function () {
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_message_service__["a" /* MessageService */], __WEBPACK_IMPORTED_MODULE_3__services_campaign_service__["a" /* CampaignService */]])
    ], LoginComponent);
...
var MessageService = (function () {
    ...
    MessageService.prototype.push = function (msg) {
        if (!this.messages) {
            this.messages = [];
        }
