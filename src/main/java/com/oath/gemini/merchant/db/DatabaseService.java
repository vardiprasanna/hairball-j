 ...
 */
@Slf4j @Singleton public class DatabaseService {
    @Inject protected SessionFactory sessionFactory;

    /**
     * Copy named properties from source to target except those excluded fields
     */
    @SuppressWarnings(value = { "unchecked", "rawtypes" }) public static <T> boolean copyNonNullProperties(T targetEntity, T sourceEntity,
    ...
    @SuppressWarnings("unchecked") public StoreAcctEntity findStoreAcctByDomain(String domain) {
        Session session = sessionFactory.openSession();
    ...
    @SuppressWarnings("unchecked") public StoreCampaignEntity findStoreCampaignByGeminiCampaignId(long id) {
        Session session = sessionFactory.openSession();
    ...
    @SuppressWarnings("unchecked") public StoreSysEntity findStoreSysByDoman(String domain) {
        Session session = sessionFactory.openSession();
    ...
    @SuppressWarnings("unchecked") public <T> List<T> findAllByAny(T entity) throws Exception {
    ...
    @SuppressWarnings("unchecked") public <T> T findByEntityId(Class<T> entityClass, Integer id) {
        Session session = sessionFactory.openSession();
    ...
    @SuppressWarnings("unchecked") public <T> T findByAcctId(Class<T> entityClass, Integer id) {
        Session session = sessionFactory.openSession();
    ...
    @SuppressWarnings("unchecked") public <T> List<T> listAll(Class<T> entity) {
        Session session = sessionFactory.openSession();
        try {
